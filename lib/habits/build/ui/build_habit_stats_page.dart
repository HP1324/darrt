...
class StatsPage extends StatefulWidget {
  const StatsPage({super.key, required this.habit});
...
class _StatsPageState extends State<StatsPage> {
  ...
  void initState() {
    super.initState();
    g.buildHabitVm.initHabitStats(widget.habit);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: getLerpedColor(context),
        title: Text(widget.habit.name.replaceAll('\n', ' ')),
        actions: [
          IconButton(
            onPressed: () => MiniRouter.to(context, BuildHabitEditor(edit: true, habit: widget.habit)),
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            StatsCalendarWidget(habit: widget.habit),
