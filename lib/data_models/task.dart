  ...
  factory Task.fromJson(Map<String, dynamic> json) {
    try {
      return Task(
        ...
        finishedAt: json['finishedAt'] != null ? DateTime.fromMillisecondsSinceEpoch(json['finishedAt']) : null,
        isNotifyEnabled: json['isNotifyEnabled'] == 1,
        notifyTime: json['notifyTime'] != null ? DateTime.fromMillisecondsSinceEpoch(json['notifyTime']) : null,
