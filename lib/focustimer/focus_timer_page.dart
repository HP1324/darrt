      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: TabBarView(
              controller: tabController,
              children: [FocusTimerTab(), SoundTab()],
            ),
          ),
        ],
      ),
...
class _TimerNotificationInfoButton extends StatelessWidget {
  const _TimerNotificationInfoButton();
