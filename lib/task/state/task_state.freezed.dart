...
mixin _$TaskState {
 ...
 String get title; Map<TaskCategory, bool> get categorySelection; DateTime get dueDate; bool get isRepeating; DateTime get startDate; DateTime? get endDate; DateTime? get startTime; DateTime? get endTime; RepeatConfig get repeatConfig; List<Reminder> get reminders; List<Note>? get notes; String get priority; int get currentPriority;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TaskState&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other.categorySelection, categorySelection)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.isRepeating, isRepeating) || other.isRepeating == isRepeating)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.repeatConfig, repeatConfig) || other.repeatConfig == repeatConfig)&&const DeepCollectionEquality().equals(other.reminders, reminders)&&const DeepCollectionEquality().equals(other.notes, notes)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.currentPriority, currentPriority) || other.currentPriority == currentPriority));
}


@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(categorySelection),dueDate,isRepeating,startDate,endDate,startTime,endTime,repeatConfig,const DeepCollectionEquality().hash(reminders),const DeepCollectionEquality().hash(notes),priority,currentPriority);

@override
String toString() {
  return 'TaskState(title: $title, categorySelection: $categorySelection, dueDate: $dueDate, isRepeating: $isRepeating, startDate: $startDate, endDate: $endDate, startTime: $startTime, endTime: $endTime, repeatConfig: $repeatConfig, reminders: $reminders, notes: $notes, priority: $priority, currentPriority: $currentPriority)';
}
...
@useResult
$Res call({
 String title, Map<TaskCategory, bool> categorySelection, DateTime dueDate, bool isRepeating, DateTime startDate, DateTime? endDate, DateTime? startTime, DateTime? endTime, RepeatConfig repeatConfig, List<Reminder> reminders, List<Note>? notes, String priority, int currentPriority
});
...
/// Create a copy of TaskState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? title = null,Object? categorySelection = null,Object? dueDate = null,Object? isRepeating = null,Object? startDate = null,Object? endDate = freezed,Object? startTime = freezed,Object? endTime = freezed,Object? repeatConfig = null,Object? reminders = null,Object? notes = freezed,Object? priority = null,Object? currentPriority = null,}) {
...
as List<Note>?,priority: null == priority ? _self.priority : priority // ignore: cast_nullable_to_non_nullable
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TaskState&&(identical(other.title, title) || other.title == title)&&const DeepCollectionEquality().equals(other._categorySelection, _categorySelection)&&(identical(other.dueDate, dueDate) || other.dueDate == dueDate)&&(identical(other.isRepeating, isRepeating) || other.isRepeating == isRepeating)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.startTime, startTime) || other.startTime == startTime)&&(identical(other.endTime, endTime) || other.endTime == endTime)&&(identical(other.repeatConfig, repeatConfig) || other.repeatConfig == repeatConfig)&&const DeepCollectionEquality().equals(other._reminders, _reminders)&&const DeepCollectionEquality().equals(other._notes, _notes)&&(identical(other.priority, priority) || other.priority == priority)&&(identical(other.currentPriority, currentPriority) || other.currentPriority == currentPriority));
}


@override
int get hashCode => Object.hash(runtimeType,title,const DeepCollectionEquality().hash(_categorySelection),dueDate,isRepeating,startDate,endDate,startTime,endTime,repeatConfig,const DeepCollectionEquality().hash(_reminders),const DeepCollectionEquality().hash(_notes),priority,currentPriority);
...
/// Create a copy of TaskState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? title = null,Object? categorySelection = null,Object? dueDate = null,Object? isRepeating = null,Object? startDate = null,Object? endDate = freezed,Object? startTime = freezed,Object? endTime = freezed,Object? repeatConfig = null,Object? reminders = null,Object? notes = freezed,Object? priority = null,Object? currentPriority = null,}) {
