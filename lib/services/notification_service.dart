...
class NotificationService {
  ...
  static Future<void> initNotifications() async {
    bool allowed = false;
    if (!await _notif.isNotificationAllowed()) {
  ...
  static Future<bool> managePermission(BuildContext context) async {
    ...
    List<NotificationPermission> lockedPermissions = await _notif.shouldShowRationaleToRequest(channelKey: 'task_notif');
            ...
            actions: [
              InkWell(
                onTap: () async {
                  ...
                  isAllowed = await _notif.requestPermissionToSendNotifications(channelKey: 'task_notif', permissions: lockedPermissions);
