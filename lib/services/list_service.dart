...
class ListService {
  ...
  ///Icon related logic
  static final  Map<String, String> defaultIcons = {
    'Sports': 'running',
    'Health': 'heart',
    'Work': 'briefcase',
    'Shopping': 'cart',
  ...
  static final Map<String, IconData> customIcons = {
    ...
    'tennis': FontAwesomeIcons.baseball,
  ...
  static IconData getIcon(String? code){
    return customIcons[code ?? 'folder'] ?? Iconsax.folder;
  }
}
